...
const Help = `用法：
    ...
    群聊配置：
        ...
        1. "/activity 0-20" 设置群里随机回复活跃度，0 关闭，20 放大二十倍

        2. "/nsfw 0|1|2" 设置群表情搜索模式，0 正常图，1 NSFW，2 不过滤

        3. "/persona 人设内容" 设置本群摘星人设，长度不超过 300 个中文字符

        4. "/persona_clear" 清理本群自定义人设，恢复默认摘星人设

        5. 以上命令都只允许群管理员或机器人管理员使用，摘星这个名字不能改
